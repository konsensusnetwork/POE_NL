...
Eigendom is iets anders dan rijkdom, wat Menger definieert als `de volledige som van economische goederen die ter beschikking staan van een economisch\index{economisch} handelend individu.'\autocite{51} Iemands eigendom bevat ook alle niet-economische goederen, maar rijkdom verwijst alleen naar economische goederen.
